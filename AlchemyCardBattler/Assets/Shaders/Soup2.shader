...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		[HDR]_Color0("Color 0", Color) = (1.068063,0,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float simplePerlin2D1 = snoise( temp_output_2_0 );
			o.Emission = ( _Color0 * simplePerlin2D1 ).rgb;
			o.Alpha = _Float1;
			clip( simplePerlin2D1 - _Cutoff );
		}
...
/*ASEBEGIN
Version=16900
6;1.6;1524;797;2348.404;258.3989;1.730623;True;False
...
Node;AmplifyShaderEditor.ColorNode;8;-853.8445,-2.772778;Float;False;Property;_Color0;Color 0;2;1;[HDR];Create;True;0;0;False;0;1.068063,0,0,0;1.068063,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-402.1565,3.505002;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-417.6444,228.0718;Float;False;Property;_Float1;Float 1;1;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C9985D40CBC6D1043ACC1731BEF945FC0C390993